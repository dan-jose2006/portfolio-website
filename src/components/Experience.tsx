...
export default function Experience({ onShowCertificate }: ExperienceProps) {
  ...
  return (
    <section id="experience" className="relative z-20 bg-transparent pt-16 md:pt-32 pb-16 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-baseline gap-2">
              <div>
                <h4 className="text-xl sm:text-2xl font-bold text-white mb-1">AI/ML Internship</h4>
                <p className="text-lg sm:text-xl text-emerald-400 font-medium">Larsen & Toubro EduTech</p>
              </div>
          ...
          >
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-baseline gap-2">
              <div>
                <h4 className="text-xl sm:text-2xl font-bold text-white mb-1">Pre-Incubatee / Co-Founder</h4>
                <p className="text-lg sm:text-xl text-emerald-400 font-medium">CHRIST Incubation Centre (CIC)</p>
              </div>
              <div className="text-white/60 text-xs sm:text-sm font-mono bg-black/40 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full inline-block border border-white/5 shadow-inner w-fit">
